...
import com.pfg.pmcare.ServerEmailMainActivity;

import menuadapter.NavDrawerListAdapter;
import menumodel.NavDrawerItem;
...
public class HealthMainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		navMenuTitles = getResources().getStringArray(R.array.health_menu);
	...
	private void displayView(int position) {
		...
		case 0:
			...
			break;
		case 1:
			fragment = new FindPeopleFragment2();
			break;
		case 2:
			fragment = new PhotosFragment2();
			break;
		case 3:
			fragment = new CommunityFragment2();
			break;
		case 4:
			fragment = new PagesFragment2();
			break;
		case 5:
			fragment = new WhatsHotFragment2();
			break;
